...
/**
 * LandingPage component serves as the main entry point for unauthenticated users.
 * Displays application branding and provides a demo login functionality.
 * 
 * @returns {JSX.Element} The landing page with demo login
 */
